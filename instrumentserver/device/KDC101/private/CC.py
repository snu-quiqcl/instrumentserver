...
class _Thorlabs_CC(_Thorlabs_Kinesis):
    ...
    def _set_position(self, position: float, block: bool=False) -> None:
    ...
    def move_to(self, position: float, block=False) -> None:
    ...
    def move_by(self, displacement: float, block: bool = False) -> None:
    ...
    def jog(self, direction: str = 'forward', block: bool = False) -> None:
        """Performs a jog
